...
//			direction:			"ltr",
            ...
            buttons: "bold,italic,underline,strike,sup,sub,|,img,link,video,|,bullist,numlist,smilebox,|,fontcolor,fontsize,fontfamily,|,justifyleft,justifycenter,justifyright,|,quote,code,offtop,table,removeFormat",
            allButtons: {
                bold: {
                    title: CURLANG.bold,
            ...
            smileList: [
               // {title: CURLANG.sm1, img: '<img src="{themePrefix}{themeName}/img/smiles/sm1.png" class="sm">', bbcode: ":)"},
                {title: CURLANG.sm1, img: '<img src="themes/admin/images/smiles/sm1.png" class="sm">', bbcode: ":)"},
                {title: CURLANG.sm2, img: '<img src="themes/admin/images/smiles/sm2.png" class="sm">', bbcode: ":D"},
                {title: CURLANG.sm3, img: '<img src="themes/admin/images/smiles/sm3.png" class="sm">', bbcode: ";)"},
                {title: CURLANG.sm4, img: '<img src="themes/admin/images/smiles/sm4.png" class="sm">', bbcode: ":up:"},
                {title: CURLANG.sm5, img: '<img src="themes/admin/images/smiles/sm5.png" class="sm">', bbcode: ":down:"},
                {title: CURLANG.sm6, img: '<img src="themes/admin/images/smiles/sm6.png" class="sm">', bbcode: ":shock:"},
                {title: CURLANG.sm7, img: '<img src="themes/admin/images/smiles/sm7.png" class="sm">', bbcode: ":angry:"},
                {title: CURLANG.sm8, img: '<img src="themes/admin/images/smiles/sm8.png" class="sm">', bbcode: ":("},
                {title: CURLANG.sm9, img: '<img src="themes/admin/images/smiles/sm9.png" class="sm">', bbcode: ":sick:"}
            ],
    ...
    $.wysibb.prototype = {
            ...
            if (this.options.bbmode) {
                ...
                $.each(opt.rootSelector, $.proxy(function(i, s) {
                    ...
                    if ($root.is("span[wbb]") || !$root.is("span,font")) { //remove only blocks
                        ...
                        if (clear !== true)
                            $root.after(ins); //insert select html
                        if (window.getSelection) {
                            $root.html(bf);
                            if (clear !== true)
                                this.selectNode(ins);
        ...
        getHTML: function(bbdata, init, skiplt) {
            ...
            $wrap.contents().filter(function() {
                return this.nodeType == 3
            }).each($.proxy(smilerpl, this)).end().find("*").contents().filter(function() {
                return this.nodeType == 3
            }).each($.proxy(smilerpl, this));
