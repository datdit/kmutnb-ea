		...
		<div class="profile">
			...
			<dt class="popup-trigger">
				...
				<div class="popup popup-list">
					<ul>
						<li><a href="<?php echo $_postrow_val['U_PROFILE']; ?>"><?php echo ((isset($this->_rootref['L_READ_PROFILE'])) ? $this->_rootref['L_READ_PROFILE'] : ((isset($user->lang['READ_PROFILE'])) ? $user->lang['READ_PROFILE'] : '{ READ_PROFILE }')); ?></a></li>
			...
			<?php } if ($_postrow_val['RANK_TITLE'] || $_postrow_val['RANK_IMG']) {  ?><dd class="poster-rank"><?php if ($_postrow_val['RANK_IMG']) {  echo $_postrow_val['RANK_IMG']; } else { echo $_postrow_val['RANK_TITLE']; } ?></dd><?php } if ($_postrow_val['ONLINE_IMG']) {  ?><dd class="poster-online"><?php echo $_postrow_val['ONLINE_IMG']; ?></dd><?php } if ($_postrow_val['POSTER_AVATAR']) {  ?>
